...
\section{Particular case of formula \ref{eq:idx1}}
	...
	\subsection{A new system of unit}
	...
	Of course $\beta$ is not unique, but for all $ I \in \PS $ they coincide in $ \Z[\Gal( \Q(\zeta_{n/n_I})^+ / \Q   )]  $, so we can use Lemma \ref{lem:gooddef}
